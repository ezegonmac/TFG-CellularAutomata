"""
This is the main module of the project. It contains the main files of the project.

Those files are the only ones that should be executed directly.
They should be executed from the root of the project (directory containing the `src` directory).
