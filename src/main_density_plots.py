...
if __name__ == '__main__':
    ...
    # create_dataset_density_evolution_plot(DATASET10, limit=500)
    # create_dataset_density_evolution_per_S_plot(DATASET10, limit=500)
    # create_dataset_density_evolution_per_B_plot(DATASET10, limit=500)
    # create_dataset_density_evolution_plot(DATASET10, limit=500)
    ...
    # dataset = DATASET13
    # create_dataset_density_evolution_plot(dataset, limit=10, suffix='10_3', num_colors=10)
    # create_dataset_density_evolution_plot(dataset, limit=100, suffix='100_2')
    # create_dataset_density_evolution_plot(dataset, limit=200, suffix='200_2')
    # create_dataset_density_evolution_plot(dataset, limit=500, suffix='500_2')
    # create_dataset_density_evolution_plot(dataset, limit=700, suffix='700_2')
